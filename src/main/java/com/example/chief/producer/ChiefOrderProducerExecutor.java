...
public class ChiefOrderProducerExecutor {
	// via: https://github.com/awslabs/aws-big-data-blog/tree/master/aws-blog-kinesis-producer-library
	// another: https://github.com/awslabs/amazon-kinesis-producer/tree/master/java/amazon-kinesis-producer-sample
    ...
    private static final String PROPERTY_FILE = "OrderProducer.properties";
