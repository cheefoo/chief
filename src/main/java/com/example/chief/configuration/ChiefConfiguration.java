...
public class ChiefConfiguration {
    private static final Log LOG = LogFactory.getLog(ChiefConfiguration.class);
    public static final String KINESIS_CHIEF_USER_AGENT = "kinesis-chief-0.0.1";
    ...
    public static final String PROP_S3_PREFIX = "s3Prefix";
    ...
    public static final String PROP_RDS_ENDPOINT = "rdsEndpoint";
    public static final String PROP_RDS_PORT = "rdsPort";
    public static final String PROP_RDS_USERNAME = "rdsUsername";
    public static final String PROP_RDS_PASSWORD = "rdsPassword";
    public static final String PROP_RDS_DBNAME = "rdsDBName";
    ...
    public static final String PROP_ELASTICSEARCH_INDEX_PREFIX = "elasticsearchIndexPrefix";
    ...
    public static final String DEFAULT_S3_PREFIX = "";
    ...
    // Default Amazon RDS Constants
    public static final String DEFAULT_RDS_ENDPOINT = null;
    public static final String DEFAULT_RDS_PORT = "3306";
    public static final String DEFAULT_RDS_USERNAME = null;
    public static final String DEFAULT_RDS_PASSWORD = null;
    public static final String DEFAULT_RDS_DBNAME = null;
    ...
    public static final String DEFAULT_ELASTICSEARCH_INDEX_PREFIX = "IndexPrefix";
    ...
    public final String RDS_ENDPOINT;
    public final String RDS_PORT;
    public final String RDS_USERNAME;
    public final String RDS_PASSWORD;
    public final String RDS_DBNAME;
    ...
    public String ELASTICSEARCH_INDEX_PREFIX;
     ...
     */
    public ChiefConfiguration(Properties properties, AWSCredentialsProvider credentialsProvider) {
        ...
        S3_PREFIX = properties.getProperty(PROP_S3_PREFIX, DEFAULT_S3_PREFIX);
        ...
        RDS_ENDPOINT = properties.getProperty(PROP_RDS_ENDPOINT, DEFAULT_RDS_ENDPOINT);
        RDS_PORT = properties.getProperty(PROP_RDS_PORT, DEFAULT_RDS_PORT);
        RDS_USERNAME = properties.getProperty(PROP_RDS_USERNAME, DEFAULT_RDS_USERNAME);
        RDS_PASSWORD = properties.getProperty(PROP_RDS_PASSWORD, DEFAULT_RDS_PASSWORD);
        RDS_DBNAME = properties.getProperty(PROP_RDS_DBNAME, DEFAULT_RDS_DBNAME);
        ...
        ELASTICSEARCH_INDEX_PREFIX = properties.getProperty(PROP_ELASTICSEARCH_INDEX_PREFIX, DEFAULT_ELASTICSEARCH_INDEX_PREFIX);
